...
exports.KeepAliveClient = void 0;
var cbor_1 = require("@harmoniclabs/cbor");
var MiniProtocol_1 = require("../../MiniProtocol/index.js");
var KeepAliveMessage_1 = require("./KeepAliveMessage.js");
...
var agencyHeader = {
    hasAgency: true,
    protocol: MiniProtocol_1.MiniProtocol.KeepAlive
};
...
function msgToName(msg) {
    if (msg instanceof messages_1.KeepAliveDone)
        return "done";
    if (msg instanceof messages_1.KeepAliveRequest)
        return "request";
    if (msg instanceof messages_1.KeepAliveResponse)
        return "response";
    return undefined;
}
var KeepAliveClient = /** @class */ (function () {
    function KeepAliveClient(multiplexer) {
        var self = this;
        var eventListeners = {
            done: [],
            request: [],
        ...
        var queque = [];
        multiplexer.on(MiniProtocol_1.MiniProtocol.KeepAlive, function (chunk) {
            ...
            while (true) {
                ...
                offset = thing.offset;
                msg = (0, KeepAliveMessage_1.keepAliveMessageFromCborObj)(thing.parsed);
                queque.unshift(msg);
    ...
    KeepAliveClient.prototype.done = function () {
        this.mplexer.send(new messages_1.KeepAliveDone().toCbor().toBuffer(), agencyHeader);
    };
    KeepAliveClient.prototype.request = function (cookie) {
        var self = this;
        return new Promise(function (resolve) {
            ...
            self.mplexer.send(new messages_1.KeepAliveRequest({ cookie: cookie }).toCbor().toBuffer(), agencyHeader);
        });
    };
