...
export declare function canBeHash28(stuff: any): stuff is CanBeHash28;
export declare class Hash28 extends Hash {
    readonly cborRef: SubCborRef | undefined;
    constructor(bs: CanBeHash28, cborRef?: SubCborRef | undefined);
    valueOf(): string;
    clone(): Hash28;
