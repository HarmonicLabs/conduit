...
export declare function hash32bytes(hash: CanBeHash32): U8Arr<32>;
export declare function canBeHash32(stuff: any): stuff is CanBeHash32;
export declare class Hash32 extends Hash {
    readonly cborRef: SubCborRef | undefined;
    constructor(bs: string | Uint8Array | Hash32, cborRef?: SubCborRef | undefined);
