...
var PublicKey = /** @class */ (function (_super) {
    ...
    function PublicKey(pubKey, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        var _this = _super.call(this, pubKey) || this;
        _this.cborRef = cborRef;
        // --------- hash ---- //
        _this._hash = undefined;
        return _this;
    }
    Object.defineProperty(PublicKey.prototype, "hash", {
        get: function () {
            if (this._hash !== undefined
                && this._hash instanceof PubKeyHash_1.PubKeyHash)
                return this._hash;
            this._hash = new PubKeyHash_1.PubKeyHash(new Uint8Array((0, crypto_1.blake2b_224)(this.toBuffer())));
            return this._hash;
        },
        enumerable: false,
        configurable: true
