...
var ConwayTx = /** @class */ (function () {
    function ConwayTx(tx, cborRef) {
        ...
        if (!(body instanceof _1.ConwayTxBody ||
            (0, _1.isIConwayTxBody)(body)))
            throw new Error("invalid transaction body; must be instance of 'ConwayTxBody'");
        if (!(witnesses instanceof _1.ConwayTxWitnessSet ||
            (0, _1.isIConwayTxWitnessSet)(witnesses)))
            throw new Error("invalid wintesses; must be instance of 'ConwayTxWitnessSet'");
        if (!(isScriptValid === undefined ||
        ...
        if (!(auxiliaryData === undefined ||
            auxiliaryData === null ||
            auxiliaryData instanceof _1.ConwayAuxiliaryData))
            throw new Error("invalid transaction auxiliray data; must be instance of 'ConwayAuxiliaryData'");
        this.body = new _1.ConwayTxBody(body);
        this.witnesses = new _1.ConwayTxWitnessSet(witnesses, (0, getSubCborRef_1.subCborRefOrUndef)(witnesses), getAllRequiredSigners(this.body));
    ...
    ConwayTx.prototype.clone = function () {
    ...
    **/
    ConwayTx.prototype.addVKeyWitness = function (vkeyWit) {
     ...
     * otherwise nothing happens (the signature is not added)
    **/
    ConwayTx.prototype.signWith = function (signer) {
    ...
    **/
    ConwayTx.prototype.signWithCip30Wallet = function (cip30) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _c = (_b = _1.ConwayTxWitnessSet).fromCbor;
    ...
    Object.defineProperty(ConwayTx.prototype, "isComplete", {
        /**
         * @returns {boolean}
    ...
    Object.defineProperty(ConwayTx.prototype, "hash", {
        get: function () {
    ...
    ConwayTx.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ConwayTx.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ConwayTx.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    ConwayTx.fromCbor = function (cStr) {
        return ConwayTx.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ConwayTx.fromCborObj = function (cObj) {
        if (!(cObj instanceof cbor_1.CborArray
        // && cObj.array.length >= 4
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayTx");
        ...
        if (!(_isValid instanceof cbor_1.CborSimple &&
            ...
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayTx", "isScriptValid is not a boolean");
        var noConwayAuxiliaryData = _aux instanceof cbor_1.CborSimple && (_aux.simple === null || _aux.simple === undefined);
        var conwayTx = new ConwayTx({
            body: _1.ConwayTxBody.fromCborObj(_body),
            witnesses: _1.ConwayTxWitnessSet.fromCborObj(_wits),
            isScriptValid: _isValid.simple,
            auxiliaryData: noConwayAuxiliaryData ? undefined : _1.ConwayAuxiliaryData.fromCborObj(_aux)
        }, (0, getSubCborRef_1.getSubCborRef)(cObj));
        return conwayTx;
    };
    ConwayTx.prototype.toJSON = function () {
        return this.toJson();
    };
    ConwayTx.prototype.toJson = function () {
        var _a;
