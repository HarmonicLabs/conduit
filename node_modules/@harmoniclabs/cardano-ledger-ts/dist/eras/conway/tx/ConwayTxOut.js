...
exports.ConwayTxOut = exports.isIConwayTxOut = void 0;
...
exports.isIConwayTxOut = isIConwayTxOut;
var ConwayTxOut = /** @class */ (function () {
    function ConwayTxOut(ConwayTxOutput, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!((0, obj_utils_1.isObject)(ConwayTxOutput) &&
            (0, obj_utils_1.hasOwn)(ConwayTxOutput, "address") &&
            (0, obj_utils_1.hasOwn)(ConwayTxOutput, "value")))
            throw new Error("ConwayTxOutput is missing some necessary fields");
        var address = ConwayTxOutput.address, value = ConwayTxOutput.value, datum = ConwayTxOutput.datum, refScript = ConwayTxOutput.refScript;
        ...
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(ConwayTxOutput);
    }
    ConwayTxOut.prototype.clone = function () {
        var _a, _b;
    ...
    Object.defineProperty(ConwayTxOut, "fake", {
        get: function () {
            return new ConwayTxOut({
    ...
    ConwayTxOut.prototype.toData = function (version) {
        var _a, _b;
    ...
    ConwayTxOut.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ConwayTxOut.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ConwayTxOut.prototype.toCborObj = function () {
        ...
        if (!ledger_1.Value.isPositive(this.value)) {
            ...
            throw new BasePlutsError_1.BasePlutsError("ConwayTxOut values can only be positive; value was: " + JSON.stringify(this.value.toJson()));
        }
    ...
    ConwayTxOut.fromCbor = function (cStr) {
        return ConwayTxOut.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ConwayTxOut.fromCborObj = function (cObj) {
        var _a;
        ...
        // cObj instanceof CborArray && cObj.array.length >= 3
            ...
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayTxOut");
        // legacy
    ...
    ConwayTxOut.prototype.toJSON = function () { return this.toJson(); };
    ConwayTxOut.prototype.toJson = function () {
        var _a;
        return {
...
exports.ConwayTxOut = ConwayTxOut;
