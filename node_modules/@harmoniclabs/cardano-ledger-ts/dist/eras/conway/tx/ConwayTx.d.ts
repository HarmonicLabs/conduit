...
import { IConwayTxBody, IConwayTxWitnessSet, ConwayAuxiliaryData, ConwayTxBody, ConwayTxWitnessSet } from "./index.js";
...
export declare class ConwayTx implements IConwayTx, ToCbor, ToJson {
    ...
    clone(): ConwayTx;
    constructor(tx: IConwayTx, cborRef?: SubCborRef | undefined);
    /**
    ...
    **/
    signWithCip30Wallet(cip30: Cip30LikeSignConwayTx): Promise<void>;
    /**
     * @returns {boolean}
