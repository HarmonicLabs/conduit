...
exports.ConwayTxBody = exports.isIConwayTxBody = void 0;
...
var ConwayUTxO_1 = require("./ConwayUTxO.js");
...
function isIConwayTxBody(body) {
    ...
    return (fields.length >= 3 &&
        ...
        b.inputs.every(function (_in) { return _in instanceof ConwayUTxO_1.ConwayUTxO || (0, ConwayUTxO_1.isIConwayUTxO)(_in); }) &&
        (0, obj_utils_1.hasOwn)(b, "outputs") &&
        Array.isArray(b.outputs) && b.outputs.length > 0 &&
        b.outputs.every(function (out) { return out instanceof _1.ConwayTxOut || (0, _1.isIConwayTxOut)(out); }) &&
        ...
        (b.collateralReturn === undefined || b.collateralReturn instanceof _1.ConwayTxOut || (0, _1.isIConwayTxOut)(b.collateralReturn)) &&
        ...
        (b.collateralInputs === undefined || (Array.isArray(b.collateralInputs) &&
            b.collateralInputs.every(function (collateral) { return collateral instanceof ConwayUTxO_1.ConwayUTxO; }))) &&
        ...
        (b.refInputs === undefined || (Array.isArray(b.refInputs) &&
            b.refInputs.every(function (ref) { return ref instanceof ConwayUTxO_1.ConwayUTxO || (0, ConwayUTxO_1.isIConwayUTxO)(ref); }))) &&
        (b.votingProcedures === undefined || (b.votingProcedures instanceof governance_1.VotingProcedures ||
            (Array.isArray(b.votingProcedures) &&
                b.votingProcedures.length > 0 &&
                b.votingProcedures.every(governance_1.isIVotingProceduresEntry)))) && (b.proposalProcedures === undefined ||
        (Array.isArray(b.proposalProcedures) &&
            b.proposalProcedures.every(function (elem) {
                return elem instanceof governance_1.ProposalProcedure ||
                    (0, governance_1.isIProposalProcedure)(elem);
            }))) &&
        (b.currentTreasuryValue === undefined || (0, ints_1.canBeUInteger)(b.currentTreasuryValue)) &&
        (b.donation === undefined || (0, ints_1.canBeUInteger)(b.donation)));
}
exports.isIConwayTxBody = isIConwayTxBody;
var ConwayTxBody = /** @class */ (function () {
    /**
     *
     ...
     */
    function ConwayTxBody(body, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        this._isHashValid = false;
        this._hash = undefined;
        var inputs = body.inputs, outputs = body.outputs, fee = body.fee, ttl = body.ttl, certs = body.certs, withdrawals = body.withdrawals, protocolUpdate = body.protocolUpdate, auxDataHash = body.auxDataHash, validityIntervalStart = body.validityIntervalStart, mint = body.mint, scriptDataHash = body.scriptDataHash, collateralInputs = body.collateralInputs, requiredSigners = body.requiredSigners, network = body.network, collateralReturn = body.collateralReturn, totCollateral = body.totCollateral, refInputs = body.refInputs, votingProcedures = body.votingProcedures, proposalProcedures = body.proposalProcedures, currentTreasuryValue = body.currentTreasuryValue, donation = body.donation;
        // -------------------------------------- inputs -------------------------------------- //
        if (!(Array.isArray(inputs) &&
            inputs.length > 0 &&
            inputs.every(ConwayUTxO_1.isIConwayUTxO)))
            throw new Error("invalid 'inputs' field");
        this.inputs = inputs.map(function (i) { return i instanceof ConwayUTxO_1.ConwayUTxO ? i : new ConwayUTxO_1.ConwayUTxO(i); });
        // -------------------------------------- outputs -------------------------------------- //
        if (!(Array.isArray(outputs) &&
            outputs.length > 0 &&
            outputs.every(_1.isIConwayTxOut)))
            throw new Error("invald 'outputs' field");
        this.outputs = outputs.map(function (out) { return out instanceof _1.ConwayTxOut ? out : new _1.ConwayTxOut(out); });
        // -------------------------------------- fee -------------------------------------- //
        ...
        if (!(collateralInputs === undefined ||
            (Array.isArray(collateralInputs) &&
                collateralInputs.every(ConwayUTxO_1.isIConwayUTxO))))
        ...
        this.collateralInputs = collateralInputs === null || collateralInputs === void 0 ? void 0 : collateralInputs.map(function (collateral) {
            return collateral instanceof ConwayUTxO_1.ConwayUTxO ? collateral :
                new ConwayUTxO_1.ConwayUTxO(collateral);
        });
        // -------------------------------------- requiredSigners -------------------------------------- //
        ...
        if (!(collateralReturn === undefined ||
            collateralReturn instanceof _1.ConwayTxOut ||
            (0, _1.isIConwayTxOut)(collateralReturn)))
            throw new Error("invalid 'collateralReturn' field");
        this.collateralReturn = (collateralReturn === undefined ? undefined :
            collateralReturn instanceof _1.ConwayTxOut ? collateralReturn :
                new _1.ConwayTxOut(collateralReturn));
        // -------------------------------------- totCollateral -------------------------------------- //
        ...
        if (!(refInputs === undefined ||
            (Array.isArray(refInputs) &&
                refInputs.every(ConwayUTxO_1.isIConwayUTxO))))
        ...
        this.refInputs = refInputs === null || refInputs === void 0 ? void 0 : refInputs.map(function (refIn) {
            return refIn instanceof ConwayUTxO_1.ConwayUTxO ? refIn :
                new ConwayUTxO_1.ConwayUTxO(refIn);
        });
        // -------------------------------------- votingProcedures -------------------------------------- //
        if (votingProcedures !== undefined) {
            if (votingProcedures instanceof governance_1.VotingProcedures) {
                this.votingProcedures = votingProcedures;
            }
            else {
                if (!(Array.isArray(votingProcedures) &&
                    votingProcedures.length > 0 &&
                    votingProcedures.every(governance_1.isIVotingProceduresEntry)))
                    throw new Error("invalid 'votingProcedures' while constructing a 'Tx'");
                this.votingProcedures = new governance_1.VotingProcedures(votingProcedures);
            }
        }
        else
            this.votingProcedures = undefined;
        // -------------------------------------- proposalProcedures -------------------------------------- //
        if (proposalProcedures !== undefined) {
            if (!(Array.isArray(proposalProcedures) &&
                proposalProcedures.every(function (elem) {
                    return elem instanceof governance_1.ProposalProcedure ||
                        (0, governance_1.isIProposalProcedure)(elem);
                })))
                throw new Error("invalid 'proposalProcedures' while constructing a 'Tx'");
            this.proposalProcedures = proposalProcedures.map(function (elem) {
                return elem instanceof governance_1.ProposalProcedure ? elem : new governance_1.ProposalProcedure(elem);
            });
        }
        else
            this.proposalProcedures = undefined;
        // -------------------------------------- currentTreasuryValue -------------------------------------- //
        if (currentTreasuryValue !== undefined) {
            if (!((0, ints_1.canBeUInteger)(currentTreasuryValue)))
                throw new Error("invalid 'currentTreasuryValue' field");
            this.currentTreasuryValue = (0, ints_1.forceBigUInt)(currentTreasuryValue);
        }
        else
            this.currentTreasuryValue = undefined;
        // -------------------------------------- donation -------------------------------------- //
        if (donation !== undefined) {
            if (!((0, ints_1.canBeUInteger)(donation)))
                throw new Error("invalid 'donation' while constructing a 'Tx'");
            this.donation = (0, ints_1.forceBigUInt)(donation);
        }
        else
            this.donation = undefined;
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(body);
    }
    Object.defineProperty(ConwayTxBody.prototype, "hash", {
        /**
         * getter
         */
        get: function () {
    ...
    ConwayTxBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ConwayTxBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ConwayTxBody.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
        ...
        return new cbor_1.CborMap([
            ...
            this.protocolUpdate === undefined ? undefined :
                {
                    ...
                    v: (0, LegacyPPUpdateProposal_1.LegacyPPUpdateProposalToCborObj)(this.protocolUpdate, function () { return (0, protocol_1.partialConwayProtocolParametersToCborObj)(protocol_1.defaultConwayProtocolParameters); })
                },
            ...
            this.proposalProcedures === undefined || this.proposalProcedures.length === 0 ? undefined :
                {
                    k: new cbor_1.CborUInt(20),
                    v: new cbor_1.CborArray(this.proposalProcedures.map(function (prop) { return prop.toCborObj(); }))
                },
            this.currentTreasuryValue === undefined ? undefined :
                {
                    k: new cbor_1.CborUInt(21),
                    v: new cbor_1.CborUInt(this.currentTreasuryValue)
                },
            this.donation === undefined ? undefined :
                {
                    k: new cbor_1.CborUInt(22),
                    v: new cbor_1.CborUInt(this.donation)
                }
        ].filter(function (entry) { return entry !== undefined; }));
    };
    ConwayTxBody.fromCbor = function (cStr) {
        return ConwayTxBody.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ConwayTxBody.fromCborObj = function (cObj) {
        var _a;
        // console.log("cObj: ", cObj);
        if (!(cObj instanceof cbor_1.CborMap
        // && cObj.map.length >= 20 
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayTxBody");
        var fields = new Array(23).fill(undefined);
        ...
        var _b = __read(fields, 23), _ins_ = _b[0], // 0 // set
        _outs = _b[1], // 1
        _fee = _b[2], // 2
        _ttl = _b[3], // 3
        _certs_ = _b[4], // 4
        ...
        _totColl = _b[17], // 17
        _refIns = _b[18], // 18
        _voting_procedures = _b[19], // 19
        _proposal_procedures = _b[20], // 20 // set
        _current_treasury = _b[21], // 21
        _donation = _b[22] // 22
        ;
        ...
        return new ConwayTxBody({
            ...
            outputs: _outs.array.map(_1.ConwayTxOut.fromCborObj),
            fee: _fee.num,
            ttl: ttl,
            ...
            protocolUpdate: _pUp === undefined ? undefined : (0, LegacyPPUpdateProposal_1.LegacyPPUpdateProposalFromCborObj)(_pUp, function (cObj) { return (0, LegacyPPUpdateProposal_1.LegacyPPUpdateMapFromCborObj)(cObj, protocol_1.partialConwayProtocolParametersFromCborObj); }),
            ...
            collateralReturn: _collRet === undefined ? undefined : _1.ConwayTxOut.fromCborObj(_collRet),
    ...
    ConwayTxBody.prototype.toJSON = function () { return this.toJson(); };
    //** TO DO: add votingProcedures, proposalProcedures, currentTreasuryValue, donation */
    ConwayTxBody.prototype.toJson = function () {
        ...
        return {
            ...
            protocolUpdate: this.protocolUpdate === undefined ? undefined : (0, LegacyPPUpdateProposal_1.protocolUpdateToJson)(this.protocolUpdate, protocol_1.partialConwayProtocolParamsToJson),
     ...
     */
    ConwayTxBody.isValueConserved = function (tx) {
...
exports.ConwayTxBody = ConwayTxBody;
;
function txOutRefAsUTxOFromCborObj(cObj) {
    return new ConwayUTxO_1.ConwayUTxO({
        utxoRef: TxOutRef_1.TxOutRef.fromCborObj(cObj),
        resolved: _1.ConwayTxOut.fake
    });
}
