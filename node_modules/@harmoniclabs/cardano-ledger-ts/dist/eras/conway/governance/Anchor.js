...
var Anchor = /** @class */ (function () {
    function Anchor(anchor, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        var url = anchor.url, anchorDataHash = anchor.anchorDataHash;
        this.url = String(url);
        this.anchorDataHash = new hashes_1.Hash32(anchorDataHash);
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(anchor);
    }
    Anchor.prototype.toCborBytes = function () {
