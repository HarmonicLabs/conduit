...
exports.ConwayBlock = void 0;
var cbor_1 = require("@harmoniclabs/cbor");
var ConwayHeader_1 = require("../header/ConwayHeader.js");
var ConwayTxBody_1 = require("../tx/ConwayTxBody.js");
var ConwayTxWitnessSet_1 = require("../tx/ConwayTxWitnessSet.js");
var ConwayAuxiliaryData_1 = require("../tx/ConwayAuxiliaryData.js");
var getSubCborRef_1 = require("../../../utils/getSubCborRef.js");
var InvalidCborFormatError_1 = require("../../../utils/InvalidCborFormatError.js");
var ConwayBlock = /** @class */ (function () {
    function ConwayBlock(block, cborRef) {
        ...
        this.header = new ConwayHeader_1.ConwayHeader(block.header);
        this.transactionBodies = block.transactionBodies.map(function (tb) { return new ConwayTxBody_1.ConwayTxBody(tb); });
        this.transactionWitnessSets = block.transactionWitnessSets.map(function (tws) { return new ConwayTxWitnessSet_1.ConwayTxWitnessSet(tws); });
        this.auxiliaryDataSet = Object.fromEntries(Object.entries(block.auxiliaryDataSet).map(function (_a) {
            var _b = __read(_a, 2), key = _b[0], value = _b[1];
            return [key, new ConwayAuxiliaryData_1.ConwayAuxiliaryData(value)];
        }));
        this.invalidTransactions = block.invalidTransactions;
    }
    ConwayBlock.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ConwayBlock.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    ConwayBlock.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ;
    ConwayBlock.fromCbor = function (cbor) {
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return ConwayBlock.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    ;
    ConwayBlock.fromCborObj = function (cObj, _originalBytes) {
        var e_1, _a;
        if (!(cObj instanceof cbor_1.CborArray &&
            cObj.array.length >= 5))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("Conway Block must be a CBOR array with at least 5 elements");
        ...
        var header = ConwayHeader_1.ConwayHeader.fromCborObj(_header);
        ...
        var transactionBodies = _txBodies.array.map(function (tb, index) {
            ...
            return ConwayTxBody_1.ConwayTxBody.fromCborObj(tb);
        });
        ...
        var transactionWitnessSets = _txWitnessSets.array.map(function (tws, index) {
            ...
            return ConwayTxWitnessSet_1.ConwayTxWitnessSet.fromCborObj(tws);
        });
        ...
        try {
            for (var _b = __values(_auxDataSet.map), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                auxiliaryDataSet[txIndex] = ConwayAuxiliaryData_1.ConwayAuxiliaryData.fromCborObj(v);
            }
        }
        ...
        var conwayBlock = new ConwayBlock({
            header: header,
    ...
    ConwayBlock.prototype.toJSON = function () {
        return this.toJson();
    };
    ;
    ConwayBlock.prototype.toJson = function () {
...
exports.ConwayBlock = ConwayBlock;
