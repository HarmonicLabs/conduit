...
exports.ConwayHeaderBody = exports.isIConwayHeaderBody = void 0;
...
function isIConwayHeaderBody(thing) {
    return (0, obj_utils_1.isObject)(thing) && (thing instanceof ConwayHeaderBody // already validated at construction, shortcut
...
exports.isIConwayHeaderBody = isIConwayHeaderBody;
var ConwayHeaderBody = /** @class */ (function () {
    function ConwayHeaderBody(hdrBody, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!isIConwayHeaderBody(hdrBody))
            throw new Error("Invalid ConwayHeaderBody");
    ...
    ConwayHeaderBody.prototype.leaderVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.vrfResult.proofHash);
    };
    ConwayHeaderBody.prototype.clone = function () {
        var _a, _b;
    ...
    ConwayHeaderBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ConwayHeaderBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    ConwayHeaderBody.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    CDDL:
        header_body = [block_number : block_no
              ...
              , protocol_version]
    */
    ConwayHeaderBody.fromCbor = function (cbor) {
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return ConwayHeaderBody.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    ConwayHeaderBody.fromCborObj = function (cHdrBody, _originalBytes) {
        if (!(cHdrBody instanceof cbor_1.CborArray))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayHeaderBodyy");
        var _a = __read(cHdrBody instanceof cbor_1.CborArray && cHdrBody.array.length === 10
            ...
            : cHdrBody instanceof cbor_1.CborArray && cHdrBody.array[0] instanceof cbor_1.CborArray
                ...
                : (function () { throw new InvalidCborFormatError_1.InvalidCborFormatError("ConwayHeaderBody"); })(), 10), _cBlockNo = _a[0], // block_number
        _cSlotNo = _a[1], // slot
        ...
        var conwayHeaderBody = new ConwayHeaderBody({
...
exports.ConwayHeaderBody = ConwayHeaderBody;
