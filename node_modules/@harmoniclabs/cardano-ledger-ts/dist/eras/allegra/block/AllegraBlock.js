...
exports.AllegraBlock = void 0;
var cbor_1 = require("@harmoniclabs/cbor");
var InvalidCborFormatError_1 = require("../../../utils/InvalidCborFormatError.js");
var AllegraHeader_1 = require("../header/AllegraHeader.js");
var AllegraTxBody_1 = require("../tx/AllegraTxBody.js");
var AllegraTxWitnessSet_1 = require("../tx/AllegraTxWitnessSet.js");
var AllegraAuxiliaryData_1 = require("../tx/AllegraAuxiliaryData.js");
var getSubCborRef_1 = require("../../../utils/getSubCborRef.js");
var AllegraBlock = /** @class */ (function () {
    function AllegraBlock(block, cborRef) {
        ...
        this.header = new AllegraHeader_1.AllegraHeader(block.header);
        this.transactionBodies = block.transactionBodies.map(function (tb) { return new AllegraTxBody_1.AllegraTxBody(tb); });
        this.transactionWitnessSets = block.transactionWitnessSets.map(function (tws) { return new AllegraTxWitnessSet_1.AllegraTxWitnessSet(tws); });
        this.auxiliaryDataSet = Object.fromEntries(Object.entries(block.auxiliaryDataSet).map(function (_a) {
            var _b = __read(_a, 2), key = _b[0], value = _b[1];
            return [key, new AllegraAuxiliaryData_1.AllegraAuxiliaryData(value)];
        }));
    }
    AllegraBlock.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AllegraBlock.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    AllegraBlock.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ;
    AllegraBlock.fromCbor = function (cbor) {
        // console.log("AllegraBlock.fromCbor", cbor);
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return AllegraBlock.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    ;
    AllegraBlock.fromCborObj = function (cObj, _originalBytes) {
        var e_1, _a;
        // console.log("AllegraBlock.fromCborObj", cObj);
        if (!(cObj instanceof cbor_1.CborArray))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("Allegra Block must be a CBOR array with at least 5 elements");
        ...
        var header = AllegraHeader_1.AllegraHeader.fromCborObj(_header); // Assuming AllegraHeader expects [header_body, body_signature]
        ...
        var transactionBodies = _txBodies.array.map(function (tb, index) {
            ...
            return AllegraTxBody_1.AllegraTxBody.fromCborObj(tb);
        });
        ...
        var transactionWitnessSets = _txWitnessSets.array.map(function (tws, index) {
            ...
            // console.log("tws", tws);
            return AllegraTxWitnessSet_1.AllegraTxWitnessSet.fromCborObj(tws);
        });
        ...
        try {
            for (var _b = __values(_auxDataSet.map), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                auxiliaryDataSet[txIndex] = AllegraAuxiliaryData_1.AllegraAuxiliaryData.fromCborObj(v);
            }
        }
        ...
        var conwayBlock = new AllegraBlock({
            header: header,
    ...
    AllegraBlock.prototype.toJSON = function () {
        return this.toJson();
    };
    ;
    AllegraBlock.prototype.toJson = function () {
...
exports.AllegraBlock = AllegraBlock;
