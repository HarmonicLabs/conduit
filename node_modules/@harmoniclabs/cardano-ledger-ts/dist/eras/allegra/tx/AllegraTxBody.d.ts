...
import { AllegraTxOut } from "./index.js";
import { AllegraUTxO } from "./AllegraUTxO.js";
...
export declare function isIAllegraTxBody(body: Readonly<object>): body is IAllegraTxBody;
export declare class AllegraTxBody implements IAllegraTxBody, ToCbor, ToJson {
     ...
     */
    constructor(body: IAllegraTxBody, cborRef?: SubCborRef | undefined);
