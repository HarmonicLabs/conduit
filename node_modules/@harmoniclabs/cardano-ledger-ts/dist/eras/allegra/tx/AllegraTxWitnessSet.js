...
exports.AllegraTxWitnessSet = exports.isIAllegraTxWitnessSet = void 0;
...
function isIAllegraTxWitnessSet(set) {
...
exports.isIAllegraTxWitnessSet = isIAllegraTxWitnessSet;
var AllegraTxWitnessSet = /** @class */ (function () {
    function AllegraTxWitnessSet(witnesses, cborRef, allRequiredSigners) {
        if (cborRef === void 0) { cborRef = undefined; }
        if (allRequiredSigners === void 0) { allRequiredSigners = undefined; }
        var _this = this;
        var _a;
        this.cborRef = cborRef;
        if (!(isIAllegraTxWitnessSet(witnesses)))
    ...
    AllegraTxWitnessSet.prototype.toJSON = function () { return this.toJson(); };
    AllegraTxWitnessSet.prototype.toJson = function () {
        var _a, _b, _c;
        return {
    ...
    AllegraTxWitnessSet.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AllegraTxWitnessSet.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    AllegraTxWitnessSet.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
    ...
    AllegraTxWitnessSet.fromCbor = function (cStr) {
        return AllegraTxWitnessSet.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    AllegraTxWitnessSet.fromCborObj = function (cObj) {
        var _a;
        if (!(cObj instanceof cbor_1.CborMap
        // && cObj.map.length >= 3
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("AllegraTxWitnessSet");
    ...
    return AllegraTxWitnessSet;
}());
exports.AllegraTxWitnessSet = AllegraTxWitnessSet;
