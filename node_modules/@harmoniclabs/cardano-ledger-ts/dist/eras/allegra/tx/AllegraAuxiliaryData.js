...
exports.AllegraAuxiliaryData = void 0;
...
var AllegraAuxiliaryData = /** @class */ (function () {
    function AllegraAuxiliaryData(auxData, cborRef) {
    ...
    Object.defineProperty(AllegraAuxiliaryData.prototype, "hash", {
        get: function () {
    ...
    AllegraAuxiliaryData.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AllegraAuxiliaryData.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    AllegraAuxiliaryData.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    AllegraAuxiliaryData.fromCbor = function (cStr) {
        return AllegraAuxiliaryData.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    AllegraAuxiliaryData.fromCborObj = function (cObj) {
        var _a;
        ...
        if (cObj instanceof cbor_1.CborArray) {
            if (!(cObj.array[1] instanceof cbor_1.CborArray))
                throw new InvalidCborFormatError_1.InvalidCborFormatError("AllegraAuxiliaryData");
            return new AllegraAuxiliaryData({
    ...
    AllegraAuxiliaryData.prototype.toJSON = function () { return this.toJson(); };
    AllegraAuxiliaryData.prototype.toJson = function () {
        var _a, _b;
        return {
    ...
    return AllegraAuxiliaryData;
}());
exports.AllegraAuxiliaryData = AllegraAuxiliaryData;
