...
exports.AllegraHeaderBody = exports.isIAllegraHeaderBody = void 0;
...
function isIAllegraHeaderBody(thing) {
    return (0, obj_utils_1.isObject)(thing) && (thing instanceof AllegraHeaderBody ||
...
exports.isIAllegraHeaderBody = isIAllegraHeaderBody;
var AllegraHeaderBody = /** @class */ (function () {
    function AllegraHeaderBody(hdrBody, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!isIAllegraHeaderBody(hdrBody))
            throw new Error("Invalid AllegraHeaderBody");
    ...
    AllegraHeaderBody.prototype.getLeaderVrfCert = function () {
        return this.leaderVrfResult;
    };
    AllegraHeaderBody.prototype.getNonceVrfCert = function () {
        return this.nonceVrfResult;
    };
    AllegraHeaderBody.prototype.leaderVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.leaderVrfResult.proofHash);
    };
    AllegraHeaderBody.prototype.nonceVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.nonceVrfResult.proofHash);
    };
    AllegraHeaderBody.prototype.clone = function () {
        var _a, _b;
    ...
    AllegraHeaderBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AllegraHeaderBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    AllegraHeaderBody.prototype.toCborObj = function () {
    ...
    AllegraHeaderBody.fromCbor = function (cbor) {
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return AllegraHeaderBody.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    AllegraHeaderBody.fromCborObj = function (cHdrBody, _originalBytes) {
        // console.log("cHdrBody Allegra", cHdrBody);
        if (!(cHdrBody instanceof cbor_1.CborArray
        // && cHdrBody.array.length === 15
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("AllegraHeaderBody");
        var _a = __read(cHdrBody instanceof cbor_1.CborArray && cHdrBody.array.length === 15
            ...
            : cHdrBody instanceof cbor_1.CborArray && cHdrBody.array[0] instanceof cbor_1.CborArray
                ...
                : (function () { throw new InvalidCborFormatError_1.InvalidCborFormatError("AllegraHeaderBody"); })(), 15), _cBlockNo = _a[0], _cSlotNo = _a[1], _cPrevHash = _a[2], _cIssuerVkey = _a[3], _cVrfVkey = _a[4], _cNonceVrfCert = _a[5], _cLeaderVrfCert = _a[6], _cBlockBodySize = _a[7], _cBlockBodyHash = _a[8], _cOpCertHotVkey = _a[9], _cOpCertSeqNum = _a[10], _cOpCertKesPeriod = _a[11], _cOpCertSigma = _a[12], _cProtMajor = _a[13], _cProtMinor = _a[14];
    ...
    return AllegraHeaderBody;
}());
exports.AllegraHeaderBody = AllegraHeaderBody;
