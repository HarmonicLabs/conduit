...
exports.ShelleyHeaderBody = exports.isIShelleyHeaderBody = void 0;
...
function isIShelleyHeaderBody(thing) {
    return (0, obj_utils_1.isObject)(thing) && (thing instanceof ShelleyHeaderBody ||
...
exports.isIShelleyHeaderBody = isIShelleyHeaderBody;
var ShelleyHeaderBody = /** @class */ (function () {
    function ShelleyHeaderBody(hdrBody, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!isIShelleyHeaderBody(hdrBody))
            throw new Error("Invalid ShelleyHeaderBody");
    ...
    ShelleyHeaderBody.prototype.getLeaderVrfCert = function () {
        return this.leaderVrfResult;
    };
    ShelleyHeaderBody.prototype.getNonceVrfCert = function () {
        return this.nonceVrfResult;
    };
    ShelleyHeaderBody.prototype.leaderVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.leaderVrfResult.proofHash);
    };
    ShelleyHeaderBody.prototype.nonceVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.nonceVrfResult.proofHash);
    };
    ShelleyHeaderBody.prototype.clone = function () {
        var _a, _b;
    ...
    ShelleyHeaderBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ShelleyHeaderBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    ShelleyHeaderBody.prototype.toCborObj = function () {
    ...
    ShelleyHeaderBody.fromCbor = function (cbor) {
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return ShelleyHeaderBody.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    ShelleyHeaderBody.fromCborObj = function (cHdrBody, _originalBytes) {
        // console.log("cHdrBody Shelley", cHdrBody);
        if (!(cHdrBody instanceof cbor_1.CborArray
        // && cHdrBody.array.length === 15
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ShelleyHeaderBody");
        var _a = __read(cHdrBody instanceof cbor_1.CborArray && cHdrBody.array.length === 15
            ...
            : cHdrBody instanceof cbor_1.CborArray && cHdrBody.array[0] instanceof cbor_1.CborArray
                ...
                : (function () { throw new InvalidCborFormatError_1.InvalidCborFormatError("ShelleyHeaderBody"); })(), 15), _cBlockNo = _a[0], _cSlotNo = _a[1], _cPrevHash = _a[2], _cIssuerVkey = _a[3], _cVrfVkey = _a[4], _cNonceVrfCert = _a[5], _cLeaderVrfCert = _a[6], _cBlockBodySize = _a[7], _cBlockBodyHash = _a[8], _cOpCertHotVkey = _a[9], _cOpCertSeqNum = _a[10], _cOpCertKesPeriod = _a[11], _cOpCertSigma = _a[12], _cProtMajor = _a[13], _cProtMinor = _a[14];
    ...
    return ShelleyHeaderBody;
}());
exports.ShelleyHeaderBody = ShelleyHeaderBody;
