...
export declare function isIShelleyHeaderBody(thing: any): thing is IShelleyHeaderBody;
export declare class ShelleyHeaderBody implements IShelleyHeaderBody, ToCbor, IPraosHeaderBody {
    ...
    constructor(hdrBody: IShelleyHeaderBody, cborRef?: SubCborRef | undefined);
