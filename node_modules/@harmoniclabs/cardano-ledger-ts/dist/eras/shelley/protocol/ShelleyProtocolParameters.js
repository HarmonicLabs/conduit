...
exports.partialShelleyProtocolParamsToJson = exports.defaultShelleyProtocolParameters = exports.partialShelleyProtocolParametersFromCborObj = exports.partialShelleyProtocolParametersToData = exports.partialShelleyProtocolParametersToCborObj = exports.isPartialShelleyProtocolParameters = exports.isShelleyProtocolParameters = void 0;
...
function isShelleyProtocolParameters(something) {
    var expectedKeys = [
        "txFeePerByte",
        "txFeeFixed",
        "maxBlockBodySize",
...
function isPartialShelleyProtocolParameters(something) {
...
exports.isPartialShelleyProtocolParameters = isPartialShelleyProtocolParameters;
...
function partialShelleyProtocolParametersToCborObj(pps) {
...
exports.partialShelleyProtocolParametersToCborObj = partialShelleyProtocolParametersToCborObj;
function partialShelleyProtocolParametersToData(pps) {
    return cborToDataLitteral(partialShelleyProtocolParametersToCborObj(pps));
}
exports.partialShelleyProtocolParametersToData = partialShelleyProtocolParametersToData;
...
function partialShelleyProtocolParametersFromCborObj(cObj) {
    var _a;
...
exports.partialShelleyProtocolParametersFromCborObj = partialShelleyProtocolParametersFromCborObj;
exports.defaultShelleyProtocolParameters = (0, obj_utils_1.freezeAll)({
    txFeePerByte: 44,
    txFeeFixed: 155381,
...
function partialShelleyProtocolParamsToJson(pp) {
    var _a, _b, _c;
...
exports.partialShelleyProtocolParamsToJson = partialShelleyProtocolParamsToJson;
