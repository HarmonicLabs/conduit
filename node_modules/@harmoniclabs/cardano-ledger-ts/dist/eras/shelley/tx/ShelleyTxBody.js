...
exports.ShelleyTxBody = exports.isIShelleyTxBody = void 0;
...
var ShelleyUTxO_1 = require("./ShelleyUTxO.js");
...
function isIShelleyTxBody(body) {
    ...
    return (fields.length >= 3 &&
        ...
        b.inputs.every(function (_in) { return _in instanceof ShelleyUTxO_1.ShelleyUTxO || (0, ShelleyUTxO_1.isIShelleyUTxO)(_in); }) &&
        (0, obj_utils_1.hasOwn)(b, "outputs") &&
        Array.isArray(b.outputs) && b.outputs.length > 0 &&
        b.outputs.every(function (out) { return out instanceof _1.ShelleyTxOut || (0, _1.isIShelleyTxOut)(out); }) &&
...
exports.isIShelleyTxBody = isIShelleyTxBody;
var ShelleyTxBody = /** @class */ (function () {
    /**
     *
     ...
     */
    function ShelleyTxBody(body, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        this._isHashValid = false;
        this._hash = undefined;
        var inputs = body.inputs, outputs = body.outputs, fee = body.fee, ttl = body.ttl, certs = body.certs, withdrawals = body.withdrawals, protocolUpdate = body.protocolUpdate, auxDataHash = body.auxDataHash;
        // -------------------------------------- inputs -------------------------------------- //
        if (!(Array.isArray(inputs) &&
            inputs.length > 0 &&
            inputs.every(ShelleyUTxO_1.isIShelleyUTxO)))
            throw new Error("invalid 'inputs' field");
        this.inputs = inputs.map(function (i) { return i instanceof ShelleyUTxO_1.ShelleyUTxO ? i : new ShelleyUTxO_1.ShelleyUTxO(i); });
        // -------------------------------------- outputs -------------------------------------- //
        if (!(Array.isArray(outputs) &&
            outputs.length > 0 &&
            outputs.every(_1.isIShelleyTxOut)))
            throw new Error("invald 'outputs' field");
        this.outputs = outputs.map(function (out) { return out instanceof _1.ShelleyTxOut ? out : new _1.ShelleyTxOut(out); });
        // -------------------------------------- fee -------------------------------------- //
    ...
    Object.defineProperty(ShelleyTxBody.prototype, "hash", {
        /**
         * getter
         */
        get: function () {
    ...
    ShelleyTxBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ShelleyTxBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ShelleyTxBody.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
            ...
            this.protocolUpdate === undefined ? undefined :
                {
                    ...
                    v: function () { return (0, protocol_1.partialShelleyProtocolParametersToCborObj)(protocol_1.defaultShelleyProtocolParameters); }
                },
    ...
    ShelleyTxBody.fromCbor = function (cStr) {
        return ShelleyTxBody.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ShelleyTxBody.fromCborObj = function (cObj) {
        var _a;
        if (!(cObj instanceof cbor_1.CborMap
        // && cObj.map.length >= 8
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ShelleyTxBody");
        ...
        var _b = __read(fields, 8), _ins_ = _b[0], // 0 // set
        _outs = _b[1], // 1
        _fee = _b[2], // 2
        _ttl = _b[3], // 3
        _certs_ = _b[4], // 4
        ...
        return new ShelleyTxBody({
            ...
            outputs: _outs.array.map(_1.ShelleyTxOut.fromCborObj),
            fee: _fee.num,
            ttl: ttl,
            ...
            protocolUpdate: _pUp === undefined ? undefined : (0, LegacyPPUpdateProposal_1.LegacyPPUpdateProposalFromCborObj)(_pUp, function (cObj) { return (0, LegacyPPUpdateProposal_1.LegacyPPUpdateMapFromCborObj)(cObj, protocol_1.partialShelleyProtocolParametersFromCborObj); }),
    ...
    ShelleyTxBody.prototype.toJSON = function () { return this.toJson(); };
    ShelleyTxBody.prototype.toJson = function () {
        var _a, _b, _c, _d;
        return {
            ...
            protocolUpdate: this.protocolUpdate === undefined ? undefined : (0, LegacyPPUpdateProposal_1.protocolUpdateToJson)(this.protocolUpdate, protocol_1.partialShelleyProtocolParamsToJson),
            auxDataHash: (_d = this.auxDataHash) === null || _d === void 0 ? void 0 : _d.toString(), // hash 32
        };
    };
    /**
     * tests that
     ...
     */
    ShelleyTxBody.isValueConserved = function (tx) {
    ...
    return ShelleyTxBody;
}());
exports.ShelleyTxBody = ShelleyTxBody;
;
function txOutRefAsUTxOFromCborObj(cObj) {
    return new ShelleyUTxO_1.ShelleyUTxO({
        utxoRef: TxOutRef_1.TxOutRef.fromCborObj(cObj),
        resolved: _1.ShelleyTxOut.fake
    });
}
