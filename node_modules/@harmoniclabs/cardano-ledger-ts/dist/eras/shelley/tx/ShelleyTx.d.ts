...
import { IShelleyTxBody, IShelleyTxWitnessSet, ShelleyTxBody, ShelleyTxWitnessSet } from "./index.js";
import { VKeyWitness, TxMetadata } from "../../common/index.js";
...
export declare class ShelleyTx implements IShelleyTx, ToCbor, ToJson {
    ...
    clone(): ShelleyTx;
    constructor(tx: IShelleyTx, cborRef?: SubCborRef | undefined);
    /**
    ...
    **/
    signWithCip30Wallet(cip30: Cip30LikeSignShelleyTx): Promise<void>;
    /**
     * @returns {boolean}
