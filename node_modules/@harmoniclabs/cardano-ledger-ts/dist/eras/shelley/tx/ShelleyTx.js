...
var ShelleyTx = /** @class */ (function () {
    function ShelleyTx(tx, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        var body = tx.body, witnesses = tx.witnesses, metadata = tx.metadata;
        if (!(body instanceof _1.ShelleyTxBody ||
            (0, _1.isIShelleyTxBody)(body)))
            throw new Error("invalid transaction body; must be instance of 'ShelleyTxBody'");
        if (!(witnesses instanceof _1.ShelleyTxWitnessSet ||
            (0, _1.isIShelleyTxWitnessSet)(witnesses)))
        ...
        this.body = new _1.ShelleyTxBody(body);
        this.witnesses = new _1.ShelleyTxWitnessSet(witnesses, (0, getSubCborRef_1.subCborRefOrUndef)(witnesses), getAllRequiredSigners(this.body));
        this.metadata = metadata;
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(tx);
    }
    ShelleyTx.prototype.clone = function () {
    ...
    **/
    ShelleyTx.prototype.addVKeyWitness = function (vkeyWit) {
     ...
     * otherwise nothing happens (the signature is not added)
    **/
    ShelleyTx.prototype.signWith = function (signer) {
    ...
    **/
    ShelleyTx.prototype.signWithCip30Wallet = function (cip30) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _c = (_b = _1.ShelleyTxWitnessSet).fromCbor;
    ...
    Object.defineProperty(ShelleyTx.prototype, "isComplete", {
        /**
         * @returns {boolean}
    ...
    Object.defineProperty(ShelleyTx.prototype, "hash", {
        get: function () {
    ...
    ShelleyTx.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ShelleyTx.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ShelleyTx.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    ShelleyTx.fromCbor = function (cStr) {
        return ShelleyTx.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ShelleyTx.fromCborObj = function (cObj) {
        if (!(cObj instanceof cbor_1.CborArray
            && cObj.array.length >= 3))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ShelleyTx");
        var _a = __read(cObj.array, 3), _body = _a[0], _wits = _a[1], _metadata = _a[2];
        var noMetadataData = _metadata instanceof cbor_1.CborSimple && (_metadata.simple === null || _metadata.simple === undefined);
        return new ShelleyTx({
            body: _1.ShelleyTxBody.fromCborObj(_body),
            witnesses: _1.ShelleyTxWitnessSet.fromCborObj(_wits),
            metadata: noMetadataData ? undefined : common_1.TxMetadata.fromCborObj(_metadata)
        }, (0, getSubCborRef_1.getSubCborRef)(cObj));
    };
    ShelleyTx.prototype.toJSON = function () {
        return this.toJson();
    };
    ShelleyTx.prototype.toJson = function () {
        var _a;
