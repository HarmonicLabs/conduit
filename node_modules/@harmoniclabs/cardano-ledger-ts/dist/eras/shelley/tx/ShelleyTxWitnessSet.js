...
exports.ShelleyTxWitnessSet = exports.isIShelleyTxWitnessSet = void 0;
...
function isIShelleyTxWitnessSet(set) {
    if (!(0, obj_utils_1.isObject)(set))
        return false;
    var _a = set, vkeyWitnesses = _a.vkeyWitnesses, nativeScripts = _a.nativeScripts, bootstrapWitnesses = _a.bootstrapWitnesses;
    return (isUndefOrCheckedArr(vkeyWitnesses, function (vkeyWit) { return vkeyWit instanceof common_1.VKeyWitness; }) &&
        ...
        isUndefOrCheckedArr(bootstrapWitnesses, function (bootWit) { return bootWit instanceof common_1.BootstrapWitness; }));
}
exports.isIShelleyTxWitnessSet = isIShelleyTxWitnessSet;
var ShelleyTxWitnessSet = /** @class */ (function () {
    function ShelleyTxWitnessSet(witnesses, cborRef, allRequiredSigners) {
        if (cborRef === void 0) { cborRef = undefined; }
        if (allRequiredSigners === void 0) { allRequiredSigners = undefined; }
        var _this = this;
        var _a;
        this.cborRef = cborRef;
        if (!(isIShelleyTxWitnessSet(witnesses)))
        ...
        var vkeyWitnesses = witnesses.vkeyWitnesses, nativeScripts = witnesses.nativeScripts, bootstrapWitnesses = witnesses.bootstrapWitnesses;
    ...
    ShelleyTxWitnessSet.prototype.toJSON = function () { return this.toJson(); };
    ShelleyTxWitnessSet.prototype.toJson = function () {
        var _a, _b, _c;
        return {
    ...
    ShelleyTxWitnessSet.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    ShelleyTxWitnessSet.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    ShelleyTxWitnessSet.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
    ...
    ShelleyTxWitnessSet.fromCbor = function (cStr) {
        return ShelleyTxWitnessSet.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ShelleyTxWitnessSet.fromCborObj = function (cObj) {
        var _a;
        if (!(cObj instanceof cbor_1.CborMap
        // && cObj.map.length >= 3
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("ShelleyTxWitnessSet");
        var fields = new Array(3).fill(undefined);
        ...
        var _b = __read(fields, 3), _vkey = _b[0], _native = _b[1], _bootstrap = _b[2];
        ...
        return new ShelleyTxWitnessSet({
            vkeyWitnesses: _vkey === undefined ? undefined : (0, getCborSet_1.getCborSet)(_vkey).map(common_1.VKeyWitness.fromCborObj),
            ...
            bootstrapWitnesses: _bootstrap === undefined ? undefined : (0, getCborSet_1.getCborSet)(_bootstrap).map(common_1.BootstrapWitness.fromCborObj)
        }, (0, getSubCborRef_1.getSubCborRef)(cObj));
    };
    return ShelleyTxWitnessSet;
}());
exports.ShelleyTxWitnessSet = ShelleyTxWitnessSet;
