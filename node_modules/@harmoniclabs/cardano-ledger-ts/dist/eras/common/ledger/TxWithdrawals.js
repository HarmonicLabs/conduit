...
var TxWithdrawals = /** @class */ (function () {
    function TxWithdrawals(map, cborRef, network) {
        if (cborRef === void 0) { cborRef = undefined; }
        if (network === void 0) { network = "mainnet"; }
        this.cborRef = cborRef;
        if (!(isITxWithdrawals(map)))
        ...
        if (Array.isArray(map)) {
            var _map = map.map(function (entry) { return ({
                rewardAccount: entry.rewardAccount instanceof StakeAddress_1.StakeAddress ?
                    ...
                    new StakeAddress_1.StakeAddress({
                        network: network,
                        credentials: new hashes_1.Hash28(entry.rewardAccount),
                        type: "stakeKey"
                    }),
    ...
    TxWithdrawals.prototype.toCborBytes = function () {
