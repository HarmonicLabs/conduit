    ...
    TxMetadata.fromCborObj = function (cObj) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (!(k instanceof cbor_1.CborUInt))
                throw new InvalidCborFormatError_1.InvalidCborFormatError("TxMetadata: " + k);
