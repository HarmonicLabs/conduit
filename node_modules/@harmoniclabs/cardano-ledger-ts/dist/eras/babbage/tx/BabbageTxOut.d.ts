...
export declare function isIBabbageTxOut(stuff: any): stuff is IBabbageTxOut;
export declare class BabbageTxOut implements IBabbageTxOut, ToCbor, Cloneable<BabbageTxOut>, ToData, ToJson {
    readonly cborRef: SubCborRef | undefined;
    readonly address: Address;
    readonly value: Value;
    readonly datum?: Hash32 | Data;
    readonly refScript?: Script;
    constructor(BabbageTxOutput: IBabbageTxOut, cborRef?: SubCborRef | undefined);
    clone(): BabbageTxOut;
