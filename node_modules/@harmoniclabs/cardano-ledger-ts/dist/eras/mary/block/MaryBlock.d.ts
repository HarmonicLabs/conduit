...
import { IMaryHeader, MaryHeader } from "../header/MaryHeader.js";
import { IMaryTxBody, MaryTxBody } from "../tx/MaryTxBody.js";
import { IMaryTxWitnessSet, MaryTxWitnessSet } from "../tx/MaryTxWitnessSet.js";
import { IMaryAuxiliaryData, MaryAuxiliaryData } from "../tx/MaryAuxiliaryData.js";
...
export interface IMaryBlock {
    ...
    auxiliaryDataSet: {
        [transactionIndex: number]: IMaryAuxiliaryData;
    };
}
export declare class MaryBlock implements IMaryBlock, ToCbor, ToJson {
    ...
    readonly auxiliaryDataSet: {
        [transactionIndex: number]: MaryAuxiliaryData;
    };
    constructor(block: IMaryBlock, cborRef?: SubCborRef | undefined);
    ...
    toJSON(): {
        ...
        auxiliaryDataSet: [string, MaryAuxiliaryData];
    };
    toJson(): {
        header: MaryHeader;
        transactionBodies: {
