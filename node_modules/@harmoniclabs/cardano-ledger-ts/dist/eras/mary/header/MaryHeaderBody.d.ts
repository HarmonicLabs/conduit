...
export declare function isIMaryHeaderBody(thing: any): thing is IMaryHeaderBody;
export declare class MaryHeaderBody implements IMaryHeaderBody, ToCbor, IPraosHeaderBody {
    ...
    constructor(hdrBody: IMaryHeaderBody, cborRef?: SubCborRef | undefined);
