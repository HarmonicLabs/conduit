...
exports.MaryHeaderBody = exports.isIMaryHeaderBody = void 0;
...
function isIMaryHeaderBody(thing) {
    return (0, obj_utils_1.isObject)(thing) && (thing instanceof MaryHeaderBody ||
...
exports.isIMaryHeaderBody = isIMaryHeaderBody;
var MaryHeaderBody = /** @class */ (function () {
    function MaryHeaderBody(hdrBody, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!isIMaryHeaderBody(hdrBody))
            throw new Error("Invalid MaryHeaderBody");
    ...
    MaryHeaderBody.prototype.getLeaderVrfCert = function () {
        return this.leaderVrfResult;
    };
    MaryHeaderBody.prototype.getNonceVrfCert = function () {
        return this.nonceVrfResult;
    };
    MaryHeaderBody.prototype.leaderVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.leaderVrfResult.proofHash);
    };
    MaryHeaderBody.prototype.nonceVrfOutput = function () {
        return (0, crypto_1.sha2_256_sync)(this.nonceVrfResult.proofHash);
    };
    MaryHeaderBody.prototype.clone = function () {
        var _a, _b;
    ...
    MaryHeaderBody.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    MaryHeaderBody.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return new cbor_1.CborString(this.cborRef.toBuffer());
        return cbor_1.Cbor.encode(this.toCborObj());
    };
    MaryHeaderBody.prototype.toCborObj = function () {
    ...
    MaryHeaderBody.fromCbor = function (cbor) {
        var bytes = cbor instanceof Uint8Array ? cbor : (0, cbor_1.forceCborString)(cbor).toBuffer();
        return MaryHeaderBody.fromCborObj(cbor_1.Cbor.parse(bytes, { keepRef: true }), bytes);
    };
    MaryHeaderBody.fromCborObj = function (cHdrBody, _originalBytes) {
        // console.log("cHdrBody Mary", cHdrBody);
        if (!(cHdrBody instanceof cbor_1.CborArray
        // && cHdrBody.array.length === 15
        ))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("MaryHeaderBody");
        var _a = __read(cHdrBody instanceof cbor_1.CborArray && cHdrBody.array.length === 15
            ...
            : cHdrBody instanceof cbor_1.CborArray && cHdrBody.array[0] instanceof cbor_1.CborArray
                ...
                : (function () { throw new InvalidCborFormatError_1.InvalidCborFormatError("MaryHeaderBody"); })(), 15), _cBlockNo = _a[0], _cSlotNo = _a[1], _cPrevHash = _a[2], _cIssuerVkey = _a[3], _cVrfVkey = _a[4], _cNonceVrfCert = _a[5], _cLeaderVrfCert = _a[6], _cBlockBodySize = _a[7], _cBlockBodyHash = _a[8], _cOpCertHotVkey = _a[9], _cOpCertSeqNum = _a[10], _cOpCertKesPeriod = _a[11], _cOpCertSigma = _a[12], _cProtMajor = _a[13], _cProtMinor = _a[14];
    ...
    return MaryHeaderBody;
}());
exports.MaryHeaderBody = MaryHeaderBody;
