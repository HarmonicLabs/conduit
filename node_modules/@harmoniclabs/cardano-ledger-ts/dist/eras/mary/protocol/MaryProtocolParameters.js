...
exports.partialMaryProtocolParamsToJson = exports.defaultMaryProtocolParameters = exports.partialMaryProtocolParametersFromCborObj = exports.partialMaryProtocolParametersToData = exports.partialMaryProtocolParametersToCborObj = exports.isPartialMaryProtocolParameters = exports.isMaryProtocolParameters = void 0;
...
;
function isMaryProtocolParameters(something) {
    var expectedKeys = [
        "txFeePerByte",
        "txFeeFixed",
        "maxBlockBodySize",
...
exports.isMaryProtocolParameters = isMaryProtocolParameters;
function isPartialMaryProtocolParameters(something) {
...
exports.isPartialMaryProtocolParameters = isPartialMaryProtocolParameters;
...
function partialMaryProtocolParametersToCborObj(pps) {
...
exports.partialMaryProtocolParametersToCborObj = partialMaryProtocolParametersToCborObj;
function partialMaryProtocolParametersToData(pps) {
    return cborToDataLitteral(partialMaryProtocolParametersToCborObj(pps));
}
exports.partialMaryProtocolParametersToData = partialMaryProtocolParametersToData;
...
var maxProtocolParamsEntries = 23;
function partialMaryProtocolParametersFromCborObj(cObj) {
    var _a;
    ...
    var _b = __read(fields, 23), _minFeeCoeff = _b[0], // 0: txFeePerByte
...
exports.partialMaryProtocolParametersFromCborObj = partialMaryProtocolParametersFromCborObj;
exports.defaultMaryProtocolParameters = (0, obj_utils_1.freezeAll)({
    txFeePerByte: 44,
    txFeeFixed: 155381,
    ...
    protocolVersion: new common_1.ProtocolVersion({ major: 4, minor: 0 }),
    minPoolCost: 340000000,
    utxoCostPerByte: 34482,
    maxValueSize: 5000, // Relevant for multi-asset values in Mary
});
function partialMaryProtocolParamsToJson(pp) {
    var _a, _b, _c;
...
exports.partialMaryProtocolParamsToJson = partialMaryProtocolParamsToJson;
