...
var MaryTx = /** @class */ (function () {
    function MaryTx(tx, cborRef) {
        ...
        if (!(body instanceof _1.MaryTxBody ||
            (0, _1.isIMaryTxBody)(body)))
            throw new Error("invalid transaction body; must be instance of 'MaryTxBody'");
        if (!(witnesses instanceof _1.MaryTxWitnessSet ||
            (0, _1.isIMaryTxWitnessSet)(witnesses)))
            throw new Error("invalid wintesses; must be instance of 'MaryTxWitnessSet'");
        if (!(auxiliaryData === undefined ||
            auxiliaryData === null ||
            auxiliaryData instanceof _1.MaryAuxiliaryData))
            throw new Error("invalid transaction auxiliray data; must be instance of 'MaryAuxiliaryData'");
        this.body = new _1.MaryTxBody(body);
        this.witnesses = new _1.MaryTxWitnessSet(witnesses, (0, getSubCborRef_1.subCborRefOrUndef)(witnesses), getAllRequiredSigners(this.body));
        this.auxiliaryData = auxiliaryData;
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(tx);
    }
    MaryTx.prototype.clone = function () {
    ...
    **/
    MaryTx.prototype.addVKeyWitness = function (vkeyWit) {
     ...
     * otherwise nothing happens (the signature is not added)
    **/
    MaryTx.prototype.signWith = function (signer) {
    ...
    **/
    MaryTx.prototype.signWithCip30Wallet = function (cip30) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _c = (_b = _1.MaryTxWitnessSet).fromCbor;
    ...
    Object.defineProperty(MaryTx.prototype, "isComplete", {
        /**
         * @returns {boolean}
    ...
    Object.defineProperty(MaryTx.prototype, "hash", {
        get: function () {
    ...
    MaryTx.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    MaryTx.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    MaryTx.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    MaryTx.fromCbor = function (cStr) {
        return MaryTx.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    MaryTx.fromCborObj = function (cObj) {
        if (!(cObj instanceof cbor_1.CborArray &&
            cObj.array.length >= 3))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("MaryTx");
        ...
        return new MaryTx({
            body: _1.MaryTxBody.fromCborObj(_body),
            witnesses: _1.MaryTxWitnessSet.fromCborObj(_wits),
            auxiliaryData: noAuxiliaryData ? undefined : _1.MaryAuxiliaryData.fromCborObj(_aux)
        }, (0, getSubCborRef_1.getSubCborRef)(cObj));
    };
    MaryTx.prototype.toJSON = function () {
        return this.toJson();
    };
    MaryTx.prototype.toJson = function () {
        var _a;
