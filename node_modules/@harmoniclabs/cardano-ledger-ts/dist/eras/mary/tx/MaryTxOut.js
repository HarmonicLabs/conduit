...
exports.MaryTxOut = exports.isIMaryTxOut = void 0;
...
exports.isIMaryTxOut = isIMaryTxOut;
var MaryTxOut = /** @class */ (function () {
    function MaryTxOut(MaryTxOutput, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!((0, obj_utils_1.isObject)(MaryTxOutput) &&
            (0, obj_utils_1.hasOwn)(MaryTxOutput, "address") &&
            (0, obj_utils_1.hasOwn)(MaryTxOutput, "value")))
            throw new Error("MaryTxOutput is missing some necessary fields");
        var address = MaryTxOutput.address, value = MaryTxOutput.value;
        ...
        this.value = value;
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(MaryTxOutput);
    }
    MaryTxOut.prototype.clone = function () {
        return new MaryTxOut({
            address: this.address.clone(),
            value: this.value.clone()
        });
    };
    Object.defineProperty(MaryTxOut, "fake", {
        get: function () {
            return new MaryTxOut({
    ...
    MaryTxOut.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    MaryTxOut.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    MaryTxOut.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
        ...
        if (!ledger_1.Value.isPositive(this.value)) {
            ...
            throw new BasePlutsError_1.BasePlutsError("MaryTxOut values can only be positive; value was: " + JSON.stringify(this.value.toJson()));
        }
    ...
    MaryTxOut.fromCbor = function (cStr) {
        return MaryTxOut.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    MaryTxOut.fromCborObj = function (cObj) {
        var _a;
        if (!(
        ...
        cObj instanceof cbor_1.CborMap && cObj.map.length >= 2 ||
            ...
            throw new InvalidCborFormatError_1.InvalidCborFormatError("MaryTxOut");
        // legacy
    ...
    MaryTxOut.prototype.toJSON = function () { return this.toJson(); };
    MaryTxOut.prototype.toJson = function () {
        return {
