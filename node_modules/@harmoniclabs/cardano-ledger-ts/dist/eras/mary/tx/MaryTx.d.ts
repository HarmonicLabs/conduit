...
import { IMaryTxBody, IMaryTxWitnessSet, MaryAuxiliaryData, MaryTxBody, MaryTxWitnessSet } from "./index.js";
...
export declare class MaryTx implements IMaryTx, ToCbor, ToJson {
    ...
    clone(): MaryTx;
    constructor(tx: IMaryTx, cborRef?: SubCborRef | undefined);
    /**
    ...
    **/
    signWithCip30Wallet(cip30: Cip30LikeSignMaryTx): Promise<void>;
    /**
     * @returns {boolean}
