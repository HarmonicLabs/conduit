...
export declare function isIAlonzoHeaderBody(thing: any): thing is IAlonzoHeaderBody;
export declare class AlonzoHeaderBody implements IAlonzoHeaderBody, ToCbor, IPraosHeaderBody {
    ...
    constructor(hdrBody: IAlonzoHeaderBody, cborRef?: SubCborRef | undefined);
