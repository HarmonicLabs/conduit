...
var AlonzoTx = /** @class */ (function () {
    function AlonzoTx(tx, cborRef) {
        ...
        if (!(body instanceof _1.AlonzoTxBody ||
            (0, _1.isIAlonzoTxBody)(body)))
            throw new Error("invalid transaction body; must be instance of 'AlonzoTxBody'");
        if (!(witnesses instanceof _1.AlonzoTxWitnessSet ||
            (0, _1.isIAlonzoTxWitnessSet)(witnesses)))
        ...
        if (!(auxiliaryData === undefined ||
            auxiliaryData === null ||
            auxiliaryData instanceof _1.AlonzoAuxiliaryData))
            throw new Error("invalid transaction auxiliray data; must be instance of 'AlonzoAuxiliaryData'");
        this.body = new _1.AlonzoTxBody(body);
        this.witnesses = new _1.AlonzoTxWitnessSet(witnesses, (0, getSubCborRef_1.subCborRefOrUndef)(witnesses), getAllRequiredSigners(this.body));
    ...
    AlonzoTx.prototype.clone = function () {
    ...
    **/
    AlonzoTx.prototype.addVKeyWitness = function (vkeyWit) {
     ...
     * otherwise nothing happens (the signature is not added)
    **/
    AlonzoTx.prototype.signWith = function (signer) {
    ...
    **/
    AlonzoTx.prototype.signWithCip30Wallet = function (cip30) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _c = (_b = _1.AlonzoTxWitnessSet).fromCbor;
    ...
    Object.defineProperty(AlonzoTx.prototype, "isComplete", {
        /**
         * @returns {boolean}
    ...
    Object.defineProperty(AlonzoTx.prototype, "hash", {
        get: function () {
    ...
    AlonzoTx.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AlonzoTx.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    AlonzoTx.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
    ...
    AlonzoTx.fromCbor = function (cStr) {
        return AlonzoTx.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    AlonzoTx.fromCborObj = function (cObj) {
        if (!(cObj instanceof cbor_1.CborArray &&
            cObj.array.length >= 4))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("AlonzoTx");
        ...
        if (!(_isValid instanceof cbor_1.CborSimple &&
            ...
            throw new InvalidCborFormatError_1.InvalidCborFormatError("AlonzoTx", "isScriptValid is not a boolean");
        var noAuxiliaryData = _aux instanceof cbor_1.CborSimple && (_aux.simple === null || _aux.simple === undefined);
        return new AlonzoTx({
            body: _1.AlonzoTxBody.fromCborObj(_body),
            witnesses: _1.AlonzoTxWitnessSet.fromCborObj(_wits),
            isScriptValid: _isValid.simple,
            auxiliaryData: noAuxiliaryData ? undefined : _1.AlonzoAuxiliaryData.fromCborObj(_aux)
        }, (0, getSubCborRef_1.getSubCborRef)(cObj));
    };
    AlonzoTx.prototype.toJSON = function () {
        return this.toJson();
    };
    AlonzoTx.prototype.toJson = function () {
        var _a;
