...
exports.AlonzoTxRedeemer = exports.AlonzoTxRedeemerTagToString = exports.AlonzoTxRedeemerTag = void 0;
...
var AlonzoTxRedeemerTag;
(function (AlonzoTxRedeemerTag) {
    AlonzoTxRedeemerTag[AlonzoTxRedeemerTag["Spend"] = 0] = "Spend";
    AlonzoTxRedeemerTag[AlonzoTxRedeemerTag["Mint"] = 1] = "Mint";
    AlonzoTxRedeemerTag[AlonzoTxRedeemerTag["Cert"] = 2] = "Cert";
    AlonzoTxRedeemerTag[AlonzoTxRedeemerTag["Withdraw"] = 3] = "Withdraw";
})(AlonzoTxRedeemerTag = exports.AlonzoTxRedeemerTag || (exports.AlonzoTxRedeemerTag = {}));
;
Object.freeze(AlonzoTxRedeemerTag);
function AlonzoTxRedeemerTagToString(tag) {
    switch (tag) {
        ...
        default:
            throw new BasePlutsError_1.BasePlutsError("invalid AlonzoTxRedeemerTag");
    }
}
exports.AlonzoTxRedeemerTagToString = AlonzoTxRedeemerTagToString;
var AlonzoTxRedeemer = /** @class */ (function () {
    function AlonzoTxRedeemer(redeemer, cborRef) {
    ...
    Object.defineProperty(AlonzoTxRedeemer.prototype, "execUnits", {
        get: function () {
    ...
    AlonzoTxRedeemer.prototype.clone = function () {
        return new AlonzoTxRedeemer(__assign(__assign({}, this), { data: this.data.clone(), execUnits: this.execUnits.clone() }));
    };
    AlonzoTxRedeemer.prototype.toCborMapEntry = function () {
        return {
    ...
    AlonzoTxRedeemer.fromCborMapEntry = function (entry) {
    ...
    AlonzoTxRedeemer.prototype.toCborBytes = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef)
            return this.cborRef.toBuffer();
        return this.toCbor().toBuffer();
    };
    AlonzoTxRedeemer.prototype.toCbor = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
    ...
    AlonzoTxRedeemer.prototype.toCborObj = function () {
        if (this.cborRef instanceof cbor_1.SubCborRef) {
            // TODO: validate cbor structure
            // we assume correctness here
    ...
    AlonzoTxRedeemer.fromCbor = function (cStr) {
        return AlonzoTxRedeemer.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    AlonzoTxRedeemer.fromCborObj = function (cObj) {
        if (!(cObj instanceof cbor_1.CborArray
            && cObj.array.length >= 4
            && cObj.array[0] instanceof cbor_1.CborUInt
            && cObj.array[1] instanceof cbor_1.CborUInt))
            throw new InvalidCborFormatError_1.InvalidCborFormatError("AlonzoTxRedeemer");
    ...
    AlonzoTxRedeemer.prototype.toJSON = function () { return this.toJson(); };
    AlonzoTxRedeemer.prototype.toJson = function () {
        return {
    ...
    return AlonzoTxRedeemer;
}());
exports.AlonzoTxRedeemer = AlonzoTxRedeemer;
