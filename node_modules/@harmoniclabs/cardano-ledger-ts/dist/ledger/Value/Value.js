...
var Value = /** @class */ (function () {
    function Value(map, cborRef) {
        ...
        /* DONE: this.cborRef */
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(map);
    }
    ...
    Object.defineProperty(Value.prototype, "lovelaces", {
        get: function () {
            var _a, _b;
            return BigInt((_b = (0, IValue_1.getEmptyNameQty)((_a = this.map
                .find(function (_a) {
    ...
    Value.prototype.toData = function (version) {
        return new plutus_data_1.DataMap(this.map.map(function (_a) {
            var policy = _a.policy, assets = _a.assets;
            return new plutus_data_1.DataPair(new plutus_data_1.DataB(policy === "" ? "" : policy.toBuffer()), new plutus_data_1.DataMap(assets.map(function (_a) {
                var _b;
                var assetName = _a.name;
                return new plutus_data_1.DataPair(new plutus_data_1.DataB(assetName), new plutus_data_1.DataI((_b = (0, IValue_1.getNameQty)(assets, assetName)) !== null && _b !== void 0 ? _b : 0));
            })));
        }));
    };
    Value.prototype.toCborBytes = function () {
