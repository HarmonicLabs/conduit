...
export declare class CertRegistrationDeposit implements ICert, ICertRegistrationDeposit {
    ...
    constructor({ stakeCredential, deposit }: ICertRegistrationDeposit, cborRef?: SubCborRef | undefined);
