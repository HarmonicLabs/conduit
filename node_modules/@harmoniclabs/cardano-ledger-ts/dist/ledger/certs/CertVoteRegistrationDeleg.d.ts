...
export declare class CertVoteRegistrationDeleg implements ICert, ICertVoteRegistrationDeleg {
    ...
    constructor({ stakeCredential, drep, coin }: ICertVoteRegistrationDeleg, cborRef?: SubCborRef | undefined);
