...
export declare class CertStakeRegistration implements ICert, ICertStakeRegistration {
    ...
    constructor({ stakeCredential }: ICertStakeRegistration, cborRef?: SubCborRef | undefined);
