...
export declare class CertUnRegistrationDeposit implements ICert, ICertUnRegistrationDeposit {
    ...
    constructor({ stakeCredential, deposit }: ICertUnRegistrationDeposit, cborRef?: SubCborRef | undefined);
