...
export declare function isIpPoolRelay(something: any): something is IpPoolRelay;
export declare function isDnsPoolRelay(something: any): something is DnsPoolRelay;
export declare function isMultiHostPoolRelay(something: any): something is MultiHostPoolRelay;
export declare function isPoolRelay(something: any): something is PoolRelay;
