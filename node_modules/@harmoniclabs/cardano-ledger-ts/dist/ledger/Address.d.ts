 ...
 */
export declare class Address implements IAddress, ToData, ToCbor {
    ...
    constructor(address: IAddress, cborRef?: SubCborRef | undefined);
    clone(): Address;
    static get fake(): Address;
    toData(version?: ToDataVersion): Data;
    static fromData(data: Data, network?: NetworkT): Address;
    toBytes(): byte[];
    static fromBytes(bs: byte[] | string | Uint8Array, cborRef?: SubCborRef | undefined): Address;
    toBuffer(): Uint8Array;
    static fromBuffer(buff: Uint8Array | string, cborRef?: SubCborRef | undefined): Address;
    /**
    ...
    */
    static fromXPrv(xprv: XPrv, network?: NetworkT, AccountIndex?: number, AddressIndex?: number): Address;
    /**
     ...
     * stake key at path   "m/1852'/1815'/0'/2/0"
    */
    static fromEntropy(entropy: Uint8Array | string, network?: NetworkT, AccountIndex?: number, AddressIndex?: number): Address;
    toCborObj(): CborObj;
