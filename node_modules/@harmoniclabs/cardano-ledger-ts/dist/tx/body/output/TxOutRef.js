...
function isITxOutRef(stuff) {
    return ((0, obj_utils_1.isObject)(stuff) &&
        (0, obj_utils_1.hasOwn)(stuff, "id") && ((typeof stuff.id === "string" && (0, hex_1.isHex)(stuff.id) && (stuff.id.length === 64)) ||
...
var TxOutRef = /** @class */ (function () {
    function TxOutRef(iTxOutRef, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        var id = iTxOutRef.id, index = iTxOutRef.index;
        if (!((typeof id === "string" && (0, hex_1.isHex)(id) && (id.length === 64)) ||
            (id instanceof hashes_1.Hash32)))
            throw new Error("tx output id (tx hash) invalid while constructing a 'UTxO'");
        this.id = id instanceof hashes_1.Hash32 ? id : new hashes_1.Hash32(id);
        this.index = Number((0, ints_1.forceBigUInt)(index));
        /* Done: cborRef */
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(iTxOutRef);
    }
    ...
    TxOutRef.prototype.toCborBytes = function () {
