...
var TxOut = /** @class */ (function () {
    function TxOut(txOutput, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        if (!((0, obj_utils_1.isObject)(txOutput) &&
            (0, obj_utils_1.hasOwn)(txOutput, "address") &&
            (0, obj_utils_1.hasOwn)(txOutput, "value")))
        ...
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(txOutput);
    }
    ...
    TxOut.prototype.toCborBytes = function () {
