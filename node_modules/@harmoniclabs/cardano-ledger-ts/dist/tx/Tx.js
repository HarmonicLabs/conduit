...
var Tx = /** @class */ (function () {
    function Tx(tx, cborRef) {
        ...
        if (!(body instanceof body_1.TxBody ||
            (0, body_1.isITxBody)(body)))
            throw new Error("invalid transaction body; must be instance of 'TxBody'");
        if (!(witnesses instanceof TxWitnessSet_1.TxWitnessSet ||
            (0, TxWitnessSet_1.isITxWitnessSet)(witnesses)))
        ...
        if (!(auxiliaryData === undefined ||
            auxiliaryData === null ||
            auxiliaryData instanceof AuxiliaryData_1.AuxiliaryData))
            throw new Error("invalid transaction auxiliray data; must be instance of 'AuxiliaryData'");
        this.body = new body_1.TxBody(body);
        this.witnesses = new TxWitnessSet_1.TxWitnessSet(witnesses, (0, getSubCborRef_1.subCborRefOrUndef)(witnesses), getAllRequiredSigners(this.body));
    ...
    **/
    Tx.prototype.addVKeyWitness = function (vkeyWit) {
    ...
    **/
    Tx.prototype.signWith = function (signer) {
        ...
        if (signer instanceof bip32_ed25519_1.XPrv) {
            ...
            this.addVKeyWitness(new TxWitnessSet_1.VKeyWitness({
                vkey: new TxWitnessSet_1.VKey(pubKey_1),
        ...
        this.addVKeyWitness(new TxWitnessSet_1.VKeyWitness({
            vkey: new TxWitnessSet_1.VKey(pubKey),
    ...
    **/
    ...
    Object.defineProperty(Tx.prototype, "isComplete", {
        /**
         * @returns {boolean}
    ...
    Tx.prototype.toCborBytes = function () {
