...
var Constitution = /** @class */ (function () {
    function Constitution(consti, cborRef) {
        if (cborRef === void 0) { cborRef = undefined; }
        this.cborRef = cborRef;
        var anchor = consti.anchor, scriptHash = consti.scriptHash;
        this.anchor = new Anchor_1.Anchor(anchor);
        this.scriptHash = (0, hashes_1.canBeHash28)(scriptHash) ? new hashes_1.Hash28(scriptHash) : undefined;
        this.cborRef = cborRef !== null && cborRef !== void 0 ? cborRef : (0, getSubCborRef_1.subCborRefOrUndef)(consti);
    }
    Constitution.prototype.toCborBytes = function () {
