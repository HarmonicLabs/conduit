import { HandshakeAcceptVersion, HandshakeClient, HandshakeRefuse, RefuseReasonHandshakeDecodeError, RefuseReasonRefuse, RefuseReasonVersionMismatch } from "@harmoniclabs/ouroboros-miniprotocols-ts";
import { logger } from "../utils/Logger.js";
export async function sync(chainSyncClient) {
    // get chain tip
    const tip = await new Promise(res => {
...
export function acquire(lsqClient, point) {
...
export async function syncAndAcquire(chainSyncClient, lsqClient, networkMagic) {
...
//# sourceMappingURL=syncAndAcquire.js.map